...
pub mod lssvm_pair_erc20 {
    ...
    pub static LSSVMPAIRERC20_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ...
    impl<M> ::core::fmt::Debug for LSSVMPairERC20<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(LSSVMPairERC20)).field(&self.address()).finish()
        }
    }
