...
pub mod erc1155_receiver {
    ...
    pub static ERC1155RECEIVER_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ...
    impl<M> ::core::fmt::Debug for ERC1155Receiver<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(ERC1155Receiver)).field(&self.address()).finish()
        }
    }
